...
// PORT: RD-X-96 outline characters carry the existing accent sheen animation.
const LOGO_RDX = `
██████╗ ██████╗       ██╗  ██╗       █████╗  ██████╗
██╔══██╗██╔══██╗      ╚██╗██╔╝      ██╔══██╗██╔════╝
██████╔╝██║  ██║█████╗ ╚███╔╝ █████╗╚██████║███████╗
...
export const LOGO = IS_FREEBUFF ? LOGO_FREEBUFF : LOGO_RDX
export const LOGO_SMALL = IS_FREEBUFF ? LOGO_SMALL_FREEBUFF : LOGO_SMALL_RDX
