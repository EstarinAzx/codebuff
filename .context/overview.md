...
The current design keeps Ghostline's layout, hot-pink banner/headings, cyan reply frames/code accents and a transparent canvas. The large logo has no duplicate small label; compact fallbacks remain. [Product](../PRODUCT.md), [selected design](../DESIGN.md), [original spec](../docs/prd.md), and [workflow](../docs/design/cbm-01-workflow.md).
